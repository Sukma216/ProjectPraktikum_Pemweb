...
<head>
    ...
    <title>Beasiswa S2 - <?php echo htmlspecialchars($user['username']); ?></title> 
    <style>
...
<body>
    ...
    <section class="bea-1">
        ...
        ?>
            <div class="row align-items-start">
                <div class="col">
                    <h1 class="title" style="color : #F27141; font-weight: bold; text-shadow: 0px 1.5px 1px rgba(0, 0, 0, 0.4);">Beasiswa S2</h1>
